  ...
  render() {
    return (
      <div>
        ...
        <PostList handleDeletePost={this.handleDeletePost} handleVoteUpPost={this.handleVoteUpPost} handleVoteDownPost={this.handleVoteDownPost} posts={this.props.posts} />
      </div>
    );
  }
}
